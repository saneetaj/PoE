...
st.sidebar.info(
    '''Upload a **Equipment List** to find the Pieces of Equipment. *Make sure you delete the any empty rows above the column titles, and delete the tags that are struck out*'''
    )
